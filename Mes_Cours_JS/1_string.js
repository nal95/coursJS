 ...
 */
 ...
 console.log(nomComplet.toUpperCase()); // toUpperCase() permet de mettre en majuscule
 console.log(nomComplet.toLowerCase());// toLowerCase() permet de mettre en minuscule 

 //Methodes avec arguments ou paramètres
 console.log(nomComplet.indexOf('o'));
